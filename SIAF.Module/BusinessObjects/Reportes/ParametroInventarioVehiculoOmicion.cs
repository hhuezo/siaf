...
namespace SIAF.Module.BusinessObjects.Reportes
{
    ...
    public class ParametroInventarioVehiculoOmicion : ReportParametersObjectBase
    {
        public ParametroInventarioVehiculoOmicion(IObjectSpaceCreator provider) : base(provider) { }
        ...
        [ModelDefault("Caption", "Omitir ambiente")]
        public Ambiente OmitirAmbiente { get; set; }


        [ModelDefault("Caption", "Omitir estado")]
