...
namespace SIAF.Module.Controllers
{
    ...
    public partial class FiltroSoftwareDescargado : ViewController
    {
        public FiltroSoftwareDescargado()
        {
            InitializeComponent();
            this.TargetObjectType = typeof(SIAF.Module.BusinessObjects.Software);
